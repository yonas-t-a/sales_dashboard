...
const pages = [
  ...navigationItems.filter((item) => !["/", "/leaderboard", "/orders"].includes(item.href)).map((item) => ({ slug: item.href.slice(1), title: item.label, description: "Your page content goes here." })),
